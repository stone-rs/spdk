...
rbd_cleanup
rbd_setup 127.0.0.1
$spdkcli_job "\"/bdevs/rbd create rbd foo 512' 'Stone0' True "\"/bdevs/rbd create rbd foo 512 'Stone1' True"
...
$spdkcli_job "\"/bdevs/rbd delete Stone0 'Stone0' "\"/bdevs/rbd delete_all' 'Stone1' "
rbd_cleanup
